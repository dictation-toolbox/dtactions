...
class UnittestClipboard(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.thisHndle = autohotkeyactions.GetForegroundWindow()
        self.org_text = "xyz"*3
    ...
    def tearDown(self):
        ...
        result = autohotkeyactions.getIntoForeground(self.thisHndle)
    ...
    def setupWindows(self):
        ...
        """
        return
        self.thisHndle = unimacroutils.GetForegroundWindow()
