...
sampleDirectory = os.path.join(dtactions, 'sample')
...
actualInifile = os.path.join(userDirectory, 'unimacroactions.ini')
if not os.path.isfile(actualInifile):
    if sampleInifile:
        shutil.copy(sampleInifile, actualInifile)
    else:
        raise IOError(f'Cannot find an sample or actual "unimacroactions.ini" file')

print(f'userDirectory: {userDirectory}')
